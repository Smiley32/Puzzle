...
/**
 * Affichage graphique haute résolution en Java.<br>
 ...
 *   - Chargement et téléchargement d'une image au format png<br>
 *   _ Temporisation d'exécution pendant une période de temps comptée en milli-secondes<br>
...
/*   */  {0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00} 
  ...
  /**
    ...
    * La methode main peut etre utilisee normalement pour envoyer des ordres a la fenetre.<br>
    * Pour quitter, la methode main devra executer un EcranGraphique.exit() pour fermer la fenetre et s'interrompre. 
    * 
    *
  ...
  /**
    ...
    * Il s'agit d'un tableau à deux indices.<br>
    ...
    * @param img Le tableau de int décrivant l'image.
    */
  ...
  /**
    * Retour du premier caractere tape au clavier non encore retourne.
    *
  ...
  public static char getKey() {
    if ( key.size() == 0 )
      return(0x00);
    Character c =(Character) key.remove(0);
    return(c.charValue());
  }
  ...
  private static double intersection(double ai,double bi,double af,double bf,double val) {
    double res = 0.0 ;
    if ( af != ai )
      res = (bi +(double) (val-ai) / (af-ai) * (bf-bi)) ;
      else
      res = 1.0e10 ;
    return(res) ;
  }
